 ...
 * 类描述： websocket鉴权的工厂类
 */
public class SocketInterfaceBeanFactory extends NettyDefaultBeanFactory {


    /**
     * 定义WebsocketInterfaceBeanFactory对象
     */
    private static SocketInterfaceBeanFactory socketInterfaceBeanFactory;

    /**
     * 使得WebsocketInterfaceBeanFactory无法在外部new对象
     */
    private SocketInterfaceBeanFactory() {
        super();
    }
     ...
     */
    public static SocketInterfaceBeanFactory getInstance() {
        if (socketInterfaceBeanFactory == null) {
            socketInterfaceBeanFactory = new SocketInterfaceBeanFactory();
        }
        return socketInterfaceBeanFactory;
    }
