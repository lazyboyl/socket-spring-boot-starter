package com.lazyboyl.socket.client.demo.netty;
...
//        ctx.writeAndFlush(Unpooled.copiedBuffer(sendInfo, CharsetUtil.UTF_8)); // 必须有flush
        SocketClientInfo.clientMap.put(ctx.channel().id().toString(),ctx);
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        SocketClientInfo.clientMap.remove(ctx.channel().id());
    }
